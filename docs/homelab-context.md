...
|---|---|---|---|
| Dell Optiplex 7040 | `lm-claw` | Ativo, IP `192.168.3.10` | Bare-metal Debian (OpenClaw + Ollama) |
...
|---|---|---|---|---|
| `192.168.3.10` | `lm-claw` | OpenClaw + Ollama | 11434, 22 | Bare-metal Optiplex |
...
| `192.168.3.10` | `74-86-7A-FA-8E-C8` | lm-claw | Bare-Metal | Cabeado |
...
| lm-claw SSH | `ssh luismarquitti@192.168.3.10` | Gestão bare-metal |
